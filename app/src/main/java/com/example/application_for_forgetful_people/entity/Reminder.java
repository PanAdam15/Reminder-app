...
public class Reminder {
    ...
    @Ignore
    public Reminder(long id, @NonNull String name, boolean ifMonday, boolean ifTuesday, boolean ifWednesday, boolean ifThursday, boolean ifFriday, boolean ifSaturday, boolean ifSunday, boolean ifBluetooth, boolean ifRing, boolean isActive, int color) {
        this.id = id;
        this.name = name;
    ...
    @Ignore
    public Reminder(@NonNull String name, boolean ifMonday, boolean ifTuesday, boolean ifWednesday, boolean ifThursday, boolean ifFriday, boolean ifSaturday, boolean ifSunday, boolean ifBluetooth, boolean ifRing, boolean isActive, int color) {
        this.name = name;
        this.ifMonday = ifMonday;
        this.ifTuesday = ifTuesday;
        this.ifWednesday = ifWednesday;
   ...
   @Ignore
    public Reminder(@NonNull String name, boolean ifMonday, boolean ifTuesday, boolean ifWednesday, boolean ifThursday, boolean ifFriday, boolean ifSaturday, boolean ifSunday, boolean ifBluetooth, boolean ifRing,int color) {
        this.name = name;
        this.ifMonday = ifMonday;
        this.ifTuesday = ifTuesday;
        this.ifWednesday = ifWednesday;
